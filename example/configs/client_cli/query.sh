...
# iroha_client_cli
#
#   account ( grant | list | list-permissions | register | set 0
...
## echo "$ iroha_client_cli account list all"
## cli account list all
## read junk

echo "$ iroha_client_cli asest list all"
cli asset   list all
read junk

## echo "$ iroha_client_cli domain list all"
## cli domain  list all
## read junk
